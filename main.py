...
def main_window():
    ...
    button_mp3 = tk.Button(button_frame,text="MP3 Downloader", command=mp3_downloader_ui)
    button_mp3.config(font=("roboto",12,"bold"),width=25,height=3,anchor="center")

    button_mp4 = tk.Button(button_frame,text="Video Downloader",command=video_downloader_ui)
...
def video_downloader_ui():
    ...
    tittle.config(font=("roboto",12,"bold"),bg="grey",fg="white",relief="raised",border=0.5,padx=10,pady=10)

    #Url label
    insertlink = tk.Label(main_frame, text="Insert your link from youtube:")
    insertlink.config(font=("roboto",10,"bold"),bg="grey",fg="white",relief="raised",border=0.5,padx=10,pady=10)

    #URL box
    linkbox = tk.Entry(main_frame, width=40)

    #On click download
    button = tk.Button(main_frame, text="Download",command=download_youtube)
    button.config(width=15,height=1,pady=5,fg="green",bg="white",relief="raised",border=5,font=("montserrat",10,"bold"))

    #Return Button
    button_return = tk.Button(window, text="Return",command=main_window)
    button_return.config(width=13,height=1,pady=5,fg="black",bg="white",relief="raised",borderwidth=5,border=5,font=("montserrat",9,"bold"))

    #Credits Label
    creator = tk.Label(window, text="By Gustavo Gorges")
    creator.config(font=("montserrat",8,"bold"),bg="#313232",fg="white",relief="sunken",border=0.5,padx=10,pady=10)
...
def mp3_downloader_ui():
    ...
    #On click download
    button = tk.Button(main_frame, text="Download",command=download_mp3youtube)
    button.config(width=15,height=1,pady=5,fg="green",bg="white",relief="raised",border=5,font=("montserrat",10,"bold"))
